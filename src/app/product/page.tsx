            ...
            <ol className="flex items-center justify-between mb-8">
              <li>
                ...
                <input
                  ref={title}
                  type="text"
                  className="w-80 text-black p-3 rounded-lg focus:outline-none focus:ring"
                  placeholder="Title"
                />
              </li>
              <li>
                ...
                <input
                  ...
                  className="w-80 text-black  p-3 rounded-lg focus:outline-none focus:ring file:mr-4 file:py-0 file:px-2
      ...
      hover:file:bg-violet-100"
            ...
            <ol className="flex items-center justify-between mb-8">
              ...
              <li>
                ...
                <select
                  ref={brendId}
                  typeof="number"
                  className="hidden_pleceholder text-black  w-80 p-3 rounded-lg focus:outline-none focus:ring"
                >
                  {brend.map((el: any) => (
            ...
            <ol className="flex items-center justify-between mb-8">
              ...
              <li>
                ...
                <select
                  ref={categoriesId}
                  className="hidden_pleceh border text-black p-3 rounded-lg focus:outline-none focus:ring"
                >
                  <option value="" disabled hidden>
